...
async function main(): Promise<void> {
  ...
  const permissionDefs = [
    ...
    { module: "privacy", action: "read", resource: "consent" },
    { module: "privacy", action: "write", resource: "consent" },
    { module: "privacy", action: "export", resource: "customer" },
    { module: "privacy", action: "correct", resource: "customer" },
    { module: "privacy", action: "erase", resource: "customer" },
    { module: "privacy", action: "read", resource: "residency" },
